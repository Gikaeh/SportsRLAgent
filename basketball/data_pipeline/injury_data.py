...
class InjuryData:
    ...
    def _correctTeamAbbreviation(self, espn_abbr):
        """
        Correct ESPN team abbreviations to match NBA API abbreviations.
    ...
    def _getTeamAbbreviation(self, team_name):
        team_map = {
    ...
    def fixTeamAbbreviations(self):
        """
        Fix team abbreviations in the injury file to match NBA API format.
        """
        if not self.injury_file.exists():
